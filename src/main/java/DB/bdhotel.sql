...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-02-2023 a las 23:37:25
...
INSERT INTO `servicio` (`codServicio`, `tipoSer`, `precio`) VALUES
(100, 'wifi', '12.00'),
(101, 'estacionamiento', '50.00');
...
--
ALTER TABLE `cuartos`
  MODIFY `codCuartos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `empleado`
--
ALTER TABLE `empleado`
  MODIFY `codEmpleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
--
ALTER TABLE `servicio`
  MODIFY `codServicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
COMMIT;
